page 50122 "AnalysisbyDimensionsCustom"
{
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action(ShowMatrixCustom)
            {
                ApplicationArea = Dimensions;
                Caption = '&Show Matrix Custom';
                Image = ShowMatrix;
                Promoted = true;
                PromotedCategory = Process;
                PromotedOnly = true;
                ...
                trigger OnAction()
                var
                    MatrixForm: Page "AnalysisbyDimensionsMatCustom";
                    i: Integer;
                begin
                    Clear(MatrixForm);
